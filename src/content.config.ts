    ...
    media: z
      .array(
        z.object({
          ...
          poster: z.string().optional(), // video thumbnail (server-generated by MediaConvert) or an audio post's owner-set cover image
          title: z.string().optional(), // audio: track title (ID3), labels a multi-track playlist
          artist: z.string().optional(), // audio: track artist (ID3)
